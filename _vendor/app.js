...
(function () {
  ...
  var COMMUNITY_API_BASE = '/.netlify/functions/arow-proxy?endpoint=';
  ...
  function tryFetchHorizons() {
    ...
    return fetch('/.netlify/functions/horizons', { signal: controller.signal })
      .then(function (resp) {
        clearTimeout(timer);
  ...
  var NEWS_API_URL = '/.netlify/functions/news';
  ...
  var SW_URL = '/.netlify/functions/space-weather';
  ...
  function init() {
    ...
    fetch('/.netlify/functions/horizons?history=2h')
      .then(function(r) { return r.ok ? r.json() : null; })
      .then(function(data) {
